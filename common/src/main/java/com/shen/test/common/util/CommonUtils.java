...
public class CommonUtils {
	...
	public static String getAllowanceSn(Integer num){
		...
		allowanceSn.append(com.shen.test.common.util.DateUtil.strByDate(new Date(),"yyyyMMdd"));
	...
	public static void main(String[] args) {
		System.out.println(com.shen.test.common.util.CommonUtils.getAllowanceSn(1));
	}
}
