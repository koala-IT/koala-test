...
public class PageList<T> {
	...
	private com.shen.test.common.util.OrderEnum order;
	...
	public com.shen.test.common.util.OrderEnum getOrder() {
		return this.order;
	}

	public void setOrder(com.shen.test.common.util.OrderEnum order) {
		this.order = order;
	}
